...
int main(){
    ...
    if(b < a && a < c){
        ...
        printf("%d < %d < %d; o menor dos 3 e o B", b, a, c); // condicao a1

    }

    if(c < a && a < b){

        printf("%d < %d < %d, o menor dos 3 e o C", c, a, b); // condicao a2

    }

    if(a < b && b < c){

        printf("%d < %d < %d, o menor dos 3 e o A", a, b, c); // condicao b1

    }

    if(c < b && b < a){

        printf("%d < %d < %d, o menor dos 3 e o C", c, b, a); // condicao b2

    }

    if(b < c && c < a){

        printf("%d < %d < %d, o menor dos 3 e o B", b, c, a); // condicao c1

    }

    if(a < c && c < b){

        printf("%d < %d < %d, o menor dos 3 e o A", a, c, b); // condicao c2

    }

    if(a == b && b == c){

        printf("%d = %d = %d, os numeros sao iguais", a, b, c);
